...
KIM, Youseung   & Communicaiton with external parties& 10\%& 0\%\\
\bottomrule
\end{tabular}
\end{center}
...
System falls back to the greedy heuristic; the assignment still completes, with a notice to the dispatcher that optimisation is degraded. \\
\bottomrule
\end{tabular}
\end{table}
