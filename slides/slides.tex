...
\begin{block}{Key insight}
  High violation rates for admission (95.8\%) and 3F X-ray (93.4\%) reflect \textbf{long fixed travel distances} --- not dispatcher error.
\end{block}
...
\begin{tikzpicture}[scale=0.88]
  ...
  \node[font=\tiny] at (2.75,2.75) {KPI violation rate: 93.4\%};
  ...
  \node[font=\tiny] at (2.75,0.65) {mean 177.0 min and 93.4\% KPI violation.};
